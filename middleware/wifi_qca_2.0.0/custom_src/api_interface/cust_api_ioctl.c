//------------------------------------------------------------------------------
// <copyright file="cust_api_ioctl.c" company="Atheros">
...
uint32_t ath_ioctl_handler(QCA_CONTEXT_STRUCT_PTR qca_ptr, ATH_IOCTL_PARAM_STRUCT_PTR param_ptr)
{
...
//}
    ...
    break;
        ...
        case ATH_GET_WEPKEY:
            ...
            A_MEMCPY(PTR_WEP_IN->keys[0], pDCxt->conn[devId].wepKeyList[PTR_WEP_IN->defKeyIndex - 1].key,
                     pDCxt->conn[devId].wepKeyList[PTR_WEP_IN->defKeyIndex - 1].keyLen);
            break;
